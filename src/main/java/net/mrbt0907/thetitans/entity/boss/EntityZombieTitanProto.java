...
public class EntityZombieTitanProto extends EntityPreTitan
{
	...
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_ZOMBIE_AMBIENT : SoundRegistry.get("titan.zombie.living");
	}
	
	protected SoundEvent getHurtSound(DamageSource source)
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_ZOMBIE_HURT : SoundRegistry.get("titan.zombie.grunt");
	}
	
	protected SoundEvent getDeathSound()
	{
		return this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? SoundEvents.ENTITY_ZOMBIE_DEATH : SoundRegistry.get("titan.zombie.death");
	}
	
	protected void playStepSound(BlockPos pos, Block blockIn)
	{
		playSound(this.getSizeMultiplier() <= 7 || this.ticksExisted <= 1 ? (this.getSizeMultiplier()  > 2 ? SoundEvents.ENTITY_ZOMBIE_STEP/*MCASounds.largefoostep*/ : SoundEvents.ENTITY_ZOMBIE_STEP) : SoundRegistry.get("titan.step"), this.getSoundVolume(), this.getSoundPitch());
	}
	...
	{
		double attack = 70D * this.getSizeMultiplier();
